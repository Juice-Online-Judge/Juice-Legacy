...
?>
		<footer>
			<div>
				<span class="link"><a href="<?php echo $prefix.'about/index.php' ?>">>關於本站</a></span>
				<span class="link"><a href="<?php echo $prefix.'about/team.php' ?>">>團隊介紹</a></span>
				<span class="link"><a href="#">>意見回饋</a></span>
			</div>
			<div>
